    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div key={item.attributes.slug} className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <img className="h-60 rounded m-auto mb-8" src={item.attributes.image.data && item.attributes.image.data.attributes.name} alt="content"/>
          ...
          <div className="hidden bg-red-800 bg-green-800 bg-purple-800 bg-blue-800 bg-yellow-800 "></div>
            <button className={"border-2 border-grey-300 ml-1 rounded-full w-6 h-6 focus:outline-none " + `bg-${item.attributes.color}-800`}></button>
          <p className="leading-relaxed text-base">{item.attributes.subtitle}</p>
...
export async function getServerSideProps(context) {
  let headers={Authorization:"Bearer "}
   //api call for edit
